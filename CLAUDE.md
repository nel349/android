# Midnight Wallet - Claude Context (Auto-Loaded)
...
## Core Mission
Build the Midnight Wallet for Android following elite engineering practices.
...
- `docs/projects/midnight-implementation-verification.md` - Crypto & transaction flows
- `docs/projects/midnight-deep-dive-round-3.md` - Configuration & state management

**Project Plan:**
- `docs/projects/midnightWallet.md` - Main implementation plan
- `docs/learning/android-weekly-checklist.md` - Progress tracking
